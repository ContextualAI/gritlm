...
global_count = 0
with open('/home2/huggingface/datasets/sentence-transformer-embedding-data/record_train.json') as f:
...
for instance in full_data:
    cur_query = instance['qas'][0]['query']
    cur_doc = instance['passage']['text']
    assert isinstance(cur_query, str)
    assert isinstance(cur_doc, str)
