...
LAUNCHER="accelerate launch \
    --config_file /home/niklas/gritlm/scripts/configs/config_8gpusfsdp_r7.yml \
    --num_machines $NNODES \
...
export CMD=" \
    -m training.run \
    --output_dir /data/niklas/gritlm/gritlm-r7 \
    --model_name_or_path RWKV/v5-Eagle-7B-HF \
    --train_data /data/niklas/gritlm/e5mini \
    --learning_rate 2e-5 \
